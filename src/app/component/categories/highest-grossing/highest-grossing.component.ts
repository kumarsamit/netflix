...
@Component({
  selector: 'app-highest-grossing',
  templateUrl: './highest-grossing.component.html',
  styleUrls: ['./highest-grossing.component.scss']
})
export class HighestGrossingComponent implements OnInit {
	list: any;
