...
@Component({
  selector: 'app-best2010',
  templateUrl: './best2010.component.html',
  styleUrls: ['./best2010.component.scss']
})
export class Best2010Component implements OnInit {
	...
	constructor(private movie: MoviesService, private route: ActivatedRoute) {
		this.movie
			.getData(
				this.base_api_url +
				'/discover/movie?primary_release_year=2010&certification.lte=G' +
				this.api_key
			)
			.subscribe((data) => {
				this.data = data;
