...
@Component({
  selector: 'app-best2015',
  templateUrl: './best2015.component.html',
  styleUrls: ['./best2015.component.scss']
})
export class Best2015Component implements OnInit {
	...
	constructor(private movie: MoviesService, private route: ActivatedRoute) {
		this.movie
			.getData(
				this.base_api_url +
				'/discover/movie?primary_release_year=2015&certification.lte=G' +
				this.api_key
			)
			.subscribe((data) => {
				this.data = data;
