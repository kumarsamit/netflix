...
@Component({
  selector: 'app-pupular-kids',
  templateUrl: './pupular-kids.component.html',
  styleUrls: ['./pupular-kids.component.scss']
})
export class PupularKidsComponent implements OnInit {
	list: any;
