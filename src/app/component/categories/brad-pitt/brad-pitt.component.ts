...
@Component({
  selector: 'app-brad-pitt',
  templateUrl: './brad-pitt.component.html',
  styleUrls: ['./brad-pitt.component.scss']
})
export class BradPittComponent implements OnInit {
